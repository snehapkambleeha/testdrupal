...
class DomainAliasController extends ControllerBase {
  ...
  /**
   * Provides title of the listing page for aliases.
   *
   * @param \Drupal\domain\DomainInterface $domain
   *   An domain record entity.
   *
   * @return string
   *   Title for aliases listing page for the domain.
   */
  public function listingTitle(DomainInterface $domain) {
    return $this->t('Aliases for %domain', ['%domain' => $domain->label()]);
  }
