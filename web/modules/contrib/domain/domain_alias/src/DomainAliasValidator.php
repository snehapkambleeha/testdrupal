...
class DomainAliasValidator implements DomainAliasValidatorInterface {
  ...
  public function validate(DomainAliasInterface $alias) {
    @trigger_error('DomainAliasValidator::validate() is deprecated in domain:3.0.0 and is removed from domain:4.0.0. Use entity constraint validation instead. See https://www.drupal.org/node/3575069', E_USER_DEPRECATED);
