...
interface DomainStorageInterface extends ConfigEntityStorageInterface {
  ...
  /**
   * Loads all domain records matching a hostname.
   *
   * Unlike loadByHostname() which returns only the first match,
   * this returns all domains sharing the given hostname. This is
   * needed for path-prefix disambiguation when multiple domains
   ...
   *
   * @return \Drupal\domain\DomainInterface[]
   *   An array of domain records, or empty if none match.
   */
