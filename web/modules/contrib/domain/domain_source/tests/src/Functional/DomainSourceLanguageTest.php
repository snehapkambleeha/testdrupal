...
class DomainSourceLanguageTest extends DomainTestBase {
  ...
  public function testDomainSourceLanguage() {
    ...
    $source_id = $this->container->get('domain_source.helper')->getSourceDomainId($translation);
    $this->assertEquals($id2, $source_id, $source_id);

    // Because of path cache, we have to flush here.
    drupal_flush_all_caches();
    // Refresh domain negotiation context after cache flush.
