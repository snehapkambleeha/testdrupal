...
class CityService {
  ...
  /**
   * Constructs a new CityService object.
   *
  ...
  public function getListofCity () {
    try {
      ...
      $response = $this->httpClient->request('GET', "https://api.restcountries.com/countries/v5?api-key=rc_live_ff59427e22da4a7b8bff22d938ab1b42");
